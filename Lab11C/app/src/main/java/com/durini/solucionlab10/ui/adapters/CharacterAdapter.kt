...
class CharacterAdapter(
    private val dataSet: MutableList<LoadCharacter>,
    private val listener: RecyclerViewCharactersEvents
) : RecyclerView.Adapter<CharacterAdapter.ViewHolder>() {

    interface  CharacterItemListener{
        fun onCharacterItemClick(charact: LoadCharacter)
    }
    ...
    class ViewHolder(
        ...
        fun setData(character: LoadCharacter) {
            character.apply {
    ...
    interface RecyclerViewCharactersEvents {
        fun onItemClicked(character: LoadCharacter)
    }
